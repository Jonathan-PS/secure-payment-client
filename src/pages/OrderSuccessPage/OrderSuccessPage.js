    ...
    axios
      ...
      .then(data => {
        ...
        for (let key in this.state.allDetails) {
          ...
          if (
            this.state.allDetails[key].token ===
    ...
    if (this.state.successDetails.length == 0) {
      ...
      return (
        <div>
          ...
          <p>{this.state.componentError.toString()}</p>
        </div>
      );
    } else {
      ...
      const prettyAmount =
        ...
        "." +
        stringAmount.slice(stringAmount.length - 2) +
        " " +
        String(successDetails.currency).toUpperCase();
        ...
        >
          <div className="col-xs-12 col-sm-6 col-md-12" align="left">
            ...
            <h1>
              ...
              {String(successDetails.outcomeSellerMessage).replace(".", "")}
            </h1>
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item">
                <b>Receipt Email</b>
                <br />
                {successDetails.receiptEmail}
              </li>
              <li class="list-group-item">
                <b>Receipt Url</b>
                <br />
                {
                  <a href={successDetails.receiptUrl} target="_blank">
                    See Receipt
                  </a>
                }
              </li>
              ...
              <div>
                <h5>
                  <i>This under will be removed! Only for show now:</i>
                </h5>
                <li>
                  <b>Success User Order ID</b> {userOrderId}
                </li>
                <li>
                  <b>Success TokenID</b> {tokenID}
                </li>
                <li>
                  <b>Paid</b> {String(successDetails.paid)}
                </li>
                <li>
                  <b>Risk Level</b> {successDetails.outcomeRiskLevel}
                </li>
                <li>
                  <b>Network Status</b>{" "}
                  {String(successDetails.outcomeNetworkStatus).replace(
                    /_/g,
                    " "
                  )}
                </li>
