...
// "rk_test..." is Restricted key (create charges)
const stripeAuthHeader = {
    'Content-Type': 'application/x-www-form-urlencoded',
    'Authorization': `Bearer rk_test_XYtWRyVUCkBpPR0AEuJYKrdA00BMWxiPcB`
}

const skus = {
    banana: "sku_Eta0InHOtUQhic",
    cucumber: "sku_Eta24AP7gtjvrz"
}

class StripeShop extends Component {
...
render() {
    ...
    const submittable = (cart.banana !== 0 || cart.cucumber !== 0) &&
        state.email && state.name && address.line1 && address.city &&
...
StripeShop.propTypes = {
    stripe: PropTypes.shape({
        createToken: PropTypes.func.isRequired
    }).isRequired
}

export default injectStripe(StripeShop)